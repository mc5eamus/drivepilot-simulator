...
class RegulatoryRegion:
    ...
    def __init__(
        self, name: str, code: str, allowed_features: List[str], speed_limit_max: float = None
    ):
        self.name = name
        self.code = code
...
class RegulatoryModeSimulator:
    ...
    def _initialize_regions(self):
        ...
        self._regions = {
            ...
            "CN": RegulatoryRegion(
                name="China",
                code="CN",
                allowed_features=["driver_monitoring", "obstacle_detection"],
                speed_limit_max=120.0,
            ),
        }
    ...
    def _handle_region_change(self, old_region: RegulatoryRegion, new_region: RegulatoryRegion):
        ...
        newly_blocked = [
            f for f in old_region.allowed_features if f not in new_region.allowed_features
        ]

        # Check for newly allowed features
        newly_allowed = [
            f for f in new_region.allowed_features if f not in old_region.allowed_features
        ]
    ...
    def _notify_region_change(self, old_region: RegulatoryRegion, new_region: RegulatoryRegion):
